      ...
      <div className="bg-white h-fit w-full sm:max-w-[350px] p-5 rounded-lg">
        ...
        <div className="flex justify-between gap-2 flex-wrap">
          <button
            ...
            className="px-4 py-2 font-semibold rounded-lg text-white border-none bg-red-500 text-sm disabled:opacity-70"
          >
            Cancel
          </button>
          <button
            ...
            className="px-4 py-2 font-semibold rounded-lg text-white bg-green-500 text-sm disabled:opacity-70"
          >
            Upload
          </button>
        </div>
